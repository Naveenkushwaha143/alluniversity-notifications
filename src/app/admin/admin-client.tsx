...
const BOARD_EXAMS: BoardExam[] = [
  // ── National ──
  { name: 'CBSE Board', desc: 'Central Board of Secondary Education - 10th & 12th board exams across India.', website: 'https://cbse.gov.in', color: 'from-blue-500 to-indigo-500', state: 'National', icon: '📘', logo: '/logos/delhi-logo-small.webp', exams: '10th & 12th', notices: ['CBSE 2025 board exam date sheet released', 'CBSE results declared for class 12', 'CBSE new assessment pattern for 2025'] },
  { name: 'CISCE (ICSE/ISC)', desc: 'Council for the Indian School Certificate Examinations.', website: 'https://cisce.org', color: 'from-sky-500 to-blue-500', state: 'National', icon: '📕', logo: '/logos/delhi-logo-small.webp', exams: '10th (ICSE) & 12th (ISC)', notices: ['ICSE 2025 timetable released', 'ISC semester exam schedule updated'] },
  { name: 'NIOS Board', desc: 'National Institute of Open Schooling for distance education.', website: 'https://nios.ac.in', color: 'from-violet-500 to-purple-500', state: 'National', icon: '📖', logo: '/logos/delhi-logo-small.webp', exams: '10th & 12th Open', notices: ['NIOS admission 2025-26 open now'] },

  // ── Bihar ──
  { name: 'Bihar Board (BSEB)', desc: 'Bihar School Examination Board - Matric (10th) & Intermediate (12th).', website: 'https://biharboardonline.bihar.gov.in', color: 'from-orange-500 to-amber-500', state: 'Bihar', icon: '📙', logo: '/logos/bihar-logo-small.webp', exams: '10th (Matric) & 12th (Inter)', notices: ['BSEB Matric result 2025 declared', 'Bihar Board 12th compartment exam dates', 'BSEB dummy registration card download'] },
  { name: 'Bihar Open Board', desc: 'Bihar Board of Open Schooling & Examination.', website: 'https://bbos.bihar.gov.in', color: 'from-amber-500 to-yellow-500', state: 'Bihar', icon: '📒', logo: '/logos/bihar-logo-small.webp', exams: '10th & 12th Open', notices: ['BBOSE admission form last date extended'] },
  { name: 'Bihar Sanskrit Board', desc: 'Bihar Sanskrit Shiksha Board for Sanskrit medium education.', website: 'https://bssbpatna.com', color: 'from-yellow-500 to-orange-500', state: 'Bihar', icon: '📿', logo: '/logos/bihar-logo-small.webp', exams: '10th & 12th Sanskrit', notices: ['Sanskrit Board exam form fill-up dates'] },
  { name: 'Bihar Madrasa Board', desc: 'Bihar State Madrasa Education Board for Islamic studies.', website: 'https://bsmeb.org', color: 'from-green-500 to-emerald-500', state: 'Bihar', icon: '🕌', logo: '/logos/bihar-logo-small.webp', exams: 'Wastania, Fauqania, Munshi, Moulvi', notices: ['Madrasa Board exam schedule 2025'] },

  // ── Haryana ──
  { name: 'Haryana Board (BSEH)', desc: 'Board of School Education Haryana - 10th & 12th.', website: 'https://bseh.org.in', color: 'from-amber-500 to-orange-500', state: 'Haryana', icon: '📔', logo: '/logos/haryana-logo-small.webp', exams: '10th & 12th', notices: ['BSEH 10th result declared', 'Haryana Board 12th re-evaluation form open', 'HBSE compartment exam dates 2025'] },

  // ── Delhi ──
  { name: 'Delhi Board', desc: 'Delhi Board of Secondary & Senior Secondary Education.', website: 'https://edudel.nic.in', color: 'from-red-500 to-rose-500', state: 'Delhi', icon: '📕', logo: '/logos/delhi-logo-small.webp', exams: '10th & 12th', notices: ['Delhi Board results announced'] },

  // ── Uttar Pradesh ──
  { name: 'UP Board (UPMSP)', desc: 'Uttar Pradesh Madhyamik Shiksha Parishad - largest board in India with 75+ districts.', website: 'https://upmsp.edu.in', color: 'from-green-500 to-emerald-500', state: 'UP', icon: '📗', logo: '/logos/up-logo-small.webp', exams: '10th (High School) & 12th (Intermediate)', notices: ['UP Board 10th result 2025 declared', 'UP Board 12th compartment exam schedule', 'UPMSP copy evaluation dates', 'UP Board marksheet download'] },
  { name: 'UP Sanskrit Board', desc: 'Uttar Pradesh Sanskrit Sansthan for Sanskrit education.', website: 'https://upsanskritparishad.up.gov.in', color: 'from-emerald-500 to-teal-500', state: 'UP', icon: '📿', logo: '/logos/up-logo-small.webp', exams: '10th & 12th Sanskrit', notices: ['UP Sanskrit Board exam dates'] },
...
const BOARD_STATE_META: Record<string, { label: string; color: string; gradient: string; logo: string; border: string; bg: string; badge: string }> = {
  National:    { label: 'National Boards',   color: 'text-blue-400',    gradient: 'from-blue-500/20 to-indigo-600/10',   logo: '/logos/delhi-logo-small.webp',    border: 'border-blue-500/20',    bg: 'bg-blue-500/10',    badge: 'bg-blue-500/20 text-blue-400' },
  Bihar:       { label: 'Bihar',             color: 'text-orange-400',  gradient: 'from-orange-500/20 to-amber-600/10',  logo: '/logos/bihar-logo-small.webp',    border: 'border-orange-500/20', bg: 'bg-orange-500/10', badge: 'bg-orange-500/20 text-orange-400' },
  Haryana:     { label: 'Haryana',           color: 'text-green-400',   gradient: 'from-green-500/20 to-emerald-600/10', logo: '/logos/haryana-logo-small.webp',  border: 'border-green-500/20',  bg: 'bg-green-500/10',  badge: 'bg-green-500/20 text-green-400' },
  Delhi:       { label: 'Delhi',             color: 'text-red-400',     gradient: 'from-red-500/20 to-rose-600/10',     logo: '/logos/delhi-logo-small.webp',    border: 'border-red-500/20',    bg: 'bg-red-500/10',    badge: 'bg-red-500/20 text-red-400' },
  UP:          { label: 'Uttar Pradesh',     color: 'text-teal-400',    gradient: 'from-teal-500/20 to-cyan-600/10',    logo: '/logos/up-logo-small.webp',       border: 'border-teal-500/20',   bg: 'bg-teal-500/10',   badge: 'bg-teal-500/20 text-teal-400' },
...
function stateLogoClass(label: string) {
  return label === 'Delhi' || label === 'UP'
    ? 'scale-[1.32] sm:scale-[1.38]'
    : 'scale-110';
}
...
export default function Home() {
  ...
  const [likedAdminPosts, setLikedAdminPosts] = useState<Set<string>>(() => {
    if (typeof window === 'undefined') return new Set();
    try {
      const storedLikes = JSON.parse(localStorage.getItem('likedAdminPosts') || '[]');
      return new Set(Array.isArray(storedLikes) ? storedLikes.filter((id) => typeof id === 'string') : []);
    } catch {
      return new Set();
    }
  });
  ...
  const fetchUniversities = useCallback(async () => {
    try {
      ...
      setDataError('Universities could not be loaded. Check your internet or server connection and try again.');
    } finally {
  ...
  const fetchNotices = useCallback(async () => {
    try {
      ...
      setDataError('Notices could not be loaded. Please try again shortly.');
    } finally {
  ...
  const fetchAdminPosts = useCallback(async () => {
    try {
      ...
      setDataError('Latest updates could not be loaded. You can still use the page.');
    } finally {
  ...
  const appendBlogContent = useCallback((snippet: string) => {
    setBlogForm((form) => {
  ...
  const insertBlogLink = useCallback(() => {
    const url = window.prompt('Paste official link URL');
    if (!url) return;
    const label = window.prompt('Link text', 'Official Link') || 'Official Link';
    appendBlogContent(`[${label}](${url})`);
  }, [appendBlogContent]);

  const formatBlogProfessionally = useCallback(() => {
    setBlogForm((form) => {
      const title = normalizeSpaces(form.title || 'Student Update');
      const content = normalizeContentLayout(form.content);
      const nextContent = /^##\s/m.test(content)
        ? content
        : [
            `## ${title}`,
            form.excerpt || deriveExcerpt(content, 160),
            '## Key Highlights',
            '- Important dates, eligibility and official instructions should be checked from the original notice.',
            '- Students should keep application details, roll number and documents ready before taking action.',
            '## Full Details',
            content,
            '## Important Links',
      ...
      return {
        ...form,
        title,
        excerpt: form.excerpt || deriveExcerpt(content, 160),
        content: nextContent,
        readTime: normalizeReadTime(form.readTime, nextContent),
      };
    });
    toast.success('Blog is ready in a professional format');
  }, []);
  ...
  const handleBlogImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!validTypes.includes(file.type)) {
      toast.error('Only image files allowed for blog');
      return;
    }
    ...
    try {
      ...
      const data = await res.json();
      if (!data.success || data.kind !== 'image') {
      ...
      setBlogForm((form) => ({
        ...form,
        coverImage: form.coverImage || data.url,
        content: `${form.content.trimEnd()}${form.content.trim() ? '\n\n' : ''}![${file.name}](${data.url})`,
      }));
      toast.success('Blog image uploaded and inserted');
    } catch {
  ...
  const handleScrapeUniversity = useCallback(async (uniId: string) => {
    ...
    if (timeSinceLastScrape < SCRAPE_COOLDOWN) {
      ...
      toast.warning(`Please wait ${waitSec} seconds, then try again`);
      return;
    }
    ...
    try {
      ...
      setScrapeProgress('Searching for the latest notifications...');
      ...
      try {
        ...
        if (statusRes.ok) {
          ...
          if (statusData.cooldownActive && statusData.cooldownMinutes > 0) {
            setScraping(false);
            toast.warning(`API is cooling down. Try again after ${statusData.cooldownMinutes} minutes.`);
            setScrapeProgress(`API cooldown is active. It will be available after ${statusData.cooldownMinutes} minutes.`);
      ...
      setScrapeProgress('Searching official sources through the API...');
      ...
      if (data.success) {
        if (data.newNotices > 0) {
          toast.success(`${uniName}: ${data.newNotices} new notices found. Please click the official website.`);
          setScrapeProgress(`${uniName}: ${data.newNotices} new notifications found. Please click the official website.`);
        } else {
          toast.info(`${uniName}: Everything is up to date. Please click the official website.`);
          setScrapeProgress(`${uniName}: All notifications are up to date. Please click the official website.`);
        }
        ...
        toast.warning(`API limit reached. Try again after ${mins} minutes.`);
        setScrapeProgress(`API limit reached. It will be available after ${mins} minutes.`);
        // Start cooldown countdown
      ...
      if (err?.name === 'AbortError') {
        ...
        setScrapeProgress('Request timed out. Please try again.');
      } else {
        toast.error('Refresh failed. Please try again.');
        setScrapeProgress('Connection failed. Please check your internet.');
      }
    } finally {
      setScraping(false);
      if (!cooldownSeconds) {
  ...
  const handleScrapeState = useCallback(async (state: string) => {
    if (scraping) return;

    try {
      setScraping(true);
      setScrapeProgress(`${state}: live refresh is running for all universities...`);

      const controller = new AbortController();
      const timeoutId = setTimeout(() => controller.abort(), 8 * 60 * 1000);
      const res = await fetch(`/api/scrape/state/${encodeURIComponent(state)}`, {
        method: 'POST',
        signal: controller.signal,
      });
      clearTimeout(timeoutId);
      ...
      if (data.success) {
        toast.success(`${state}: ${data.checkedUniversities || 0} universities checked, ${data.newNotices || 0} new notices. Please click the official website.`);
        setScrapeProgress(`${state}: ${data.checkedUniversities || 0} universities checked, ${data.newNotices || 0} new notices found. Please click the official website.`);
        await Promise.all([fetchNotices(), fetchUniversities(), fetchLiveNotifications(true)]);
      } else {
        toast.error(`${state}: ${data.message || 'Refresh failed'}`);
        setScrapeProgress(`${state}: ${data.message || 'Refresh failed'}`);
      }
    } catch (err: any) {
      if (err?.name === 'AbortError') {
        toast.error(`${state}: refresh timed out. Please try again.`);
        setScrapeProgress(`${state}: refresh timed out`);
      } else {
        toast.error(`${state}: refresh failed. Check your internet or server connection.`);
        setScrapeProgress(`${state}: refresh failed`);
      }
    } finally {
      setScraping(false);
      setTimeout(() => setScrapeProgress(''), 7000);
    }
  }, [scraping, fetchNotices, fetchUniversities, fetchLiveNotifications]);
  ...
  useEffect(() => {
    const loadLikes = window.setTimeout(() => {
      try {
        const storedLikes = JSON.parse(localStorage.getItem('likedAdminPosts') || '[]');
    ...
    return () => window.clearTimeout(loadLikes);
  }, []);
  ...
  useEffect(() => {
    ...
    const refreshNotices = window.setTimeout(() => {
      void fetchNotices();
    }, 0);
    return () => window.clearTimeout(refreshNotices);
  ...
  useEffect(() => {
    if (!selectedBlogPost) {
      const clearComments = window.setTimeout(() => setBlogComments([]), 0);
      return () => window.clearTimeout(clearComments);
    }

    const loadComments = window.setTimeout(() => {
      void fetchBlogComments(selectedBlogPost.id);
    }, 0);
    return () => {
      window.clearTimeout(loadComments);
    };
  ...
  useEffect(() => {
    ...
    runWhenIdle(() => {
      void import('socket.io-client').then(({ io }) => {
        ...
        const isLocalNext = window.location.port === '3000';
        const socketUrl = isLocalNext
        ...
        <div className="flex items-center justify-between h-15 sm:h-17">
          ...
          <button onClick={() => switchView('home')} className="brand-logo group flex items-center gap-2.5 shrink-0">
            <div className="brand-logo-mark w-11 h-11 sm:w-12 sm:h-12 rounded-full bg-black/40 border border-amber-300/35 flex items-center justify-center shadow-lg shadow-black/30 overflow-hidden">
              <img src="/logo.svg?v=20260518" alt="All University" width={48} height={48} decoding="async" className="w-full h-full object-contain" />
            </div>
          ...
          <nav className="hidden lg:flex items-center gap-1.5">
            ...
            {INFO_LINKS.map((item) => (
              <a
                key={item.href}
                href={item.href}
                className="nav-link px-3 py-2 text-[14px] font-semibold rounded-lg text-white/45 transition-all hover:bg-white/5 hover:text-white"
              >
                {item.label}
              </a>
            ))}
                ...
                {showNotifDropdown && (
                  <>
                    <motion.div
                      ...
                      className="fixed right-3 top-16 z-200 flex h-[min(32rem,calc(100dvh-5rem))] w-[calc(100vw-1.5rem)] max-w-md flex-col overflow-hidden rounded-2xl border border-white/10 glass-strong-scrolled shadow-2xl shadow-black/40 sm:absolute sm:inset-auto sm:right-0 sm:top-full sm:mt-2 sm:h-100 sm:w-104 sm:max-w-[calc(100vw-2rem)]"
                    >
                    ...
                    <div className="notif-scroll-panel min-h-0 flex-1 overflow-y-auto overscroll-contain pb-2 sm:h-100">
                    ...
                    <div className="p-4 border-b mobile-menu-border">
                      <div className="flex items-center justify-between gap-2.5">
                        ...
                        <div className="brand-logo-mark w-11 h-11 rounded-full bg-black/40 border border-amber-300/35 flex items-center justify-center overflow-hidden">
                          <img src="/logo.svg?v=20260518" alt="All University" width={44} height={44} decoding="async" className="w-full h-full object-contain" />
                        </div>
                        <div>
  ...
  const renderHomeView = () => (
    <div className="space-y-10">
      ...
      <div className="text-center space-y-5 pt-6 sm:pt-10">
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/5 border border-white/10 text-xs font-medium text-white/50">
            ...
            {[...pinnedPosts, ...activePosts].slice(0, 8).map((post, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="shrink-0 w-[calc(100vw-2rem)] max-w-96 sm:w-92 lg:w-96 snap-start group cursor-default"
                >
              ...
              <div className="prism-box">
                <div className={`prism-inner glass-card rounded-3xl p-5 sm:p-7 min-h-48 sm:min-h-56 flex flex-col items-center justify-center gap-3 sm:gap-4 border ${meta.border}`}>
                  ...
                  <div className="relative z-10 flex flex-col items-center gap-3 sm:gap-4">
                    ...
                    <div className={`group w-16 h-16 sm:w-22 sm:h-22 rounded-full bg-linear-to-br ${meta.gradient} flex items-center justify-center overflow-hidden ring-2 ring-white/10 hover:ring-white/30 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10`} style={{ '--tw-ring-color': 'rgba(255,255,255,0.15)' } as React.CSSProperties}>
                      <img src={meta.logo} alt={meta.label} className={`w-full h-full rounded-full object-cover transition-all duration-300 group-hover:scale-[1.5] group-hover:shadow-xl group-hover:shadow-black/40 ${stateLogoClass(meta.label)}`} loading="lazy" decoding="async" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                    </div>
                ...
                <div className="blog-featured-card relative overflow-hidden rounded-2xl bg-linear-to-br from-pink-500/10 via-purple-500/10 to-cyan-500/10 border border-white/10 backdrop-blur-md">
                  ...
                  <div className="relative p-5 sm:p-6 flex flex-col sm:flex-row gap-4">
                    {blogPosts[0].coverImage ? (
                      <img src={blogPosts[0].coverImage} alt="" className="w-full sm:w-40 h-28 rounded-xl object-cover shrink-0" loading="lazy" decoding="async" />
                    ) : (
                ...
                {blogPosts.slice(1).map((post, i) => (
                  ...
                  >
                    <div className="blog-list-card glass-card rounded-2xl overflow-hidden border border-white/5 hover:border-pink-500/20 transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/5 h-full">
                      {post.coverImage ? (
                        <img src={post.coverImage} alt="" className="w-full h-32 object-cover" loading="lazy" decoding="async" />
                      ) : (
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  {state === 'Bihar' && (
                    <Button
                      ...
                      size="sm"
                      disabled={scraping}
                      onClick={() => handleScrapeState('Bihar')}
                      className="ml-auto h-7 rounded-lg bg-orange-500/90 hover:bg-orange-500 text-white text-[10px] font-bold px-3"
                    >
                      {scraping ? <Loader2 className="w-3 h-3 mr-1 animate-spin" /> : <RefreshCw className="w-3 h-3 mr-1" />}
                      Refresh Bihar Live
                    </Button>
                  )}
                </div>
                                            ...
                                            <div className="flex items-center gap-2 mt-1">
                                              ...
                                              <button
                                                ...
                                                onClick={(event) => {
                                                  ...
                                                  handleScrapeUniversity(uni.id);
                                                }}
                                                className="ml-auto inline-flex h-6 w-6 items-center justify-center rounded-md bg-white/8 text-white/60 transition-colors hover:bg-cyan-400/20 hover:text-cyan-200 disabled:opacity-40"
                                              >
                                                {scraping ? <Loader2 className="w-3 h-3 animate-spin" /> : <RefreshCw className="w-3 h-3" />}
                                              </button>
                                              <ExternalLink className="focus-icon w-2.5 h-2.5 text-white/45 transition-colors" />
                                            </div>
                                          </div>
                                        </div>
                                      </CardContent>
      ...
      <AnimatePresence>
        {scrapeProgress && (
          <motion.div
            ...
            className="fixed left-4 right-4 top-24 z-80 mx-auto max-w-2xl"
          >
            <div className="rounded-2xl border border-cyan-300/35 bg-slate-950/95 p-5 text-white shadow-2xl shadow-cyan-950/40 backdrop-blur-xl">
              <div className="flex items-start gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-cyan-400/15 text-cyan-200 ring-1 ring-cyan-300/25">
                  {scraping ? <Loader2 className="h-6 w-6 animate-spin" /> : <CheckCircle2 className="h-6 w-6" />}
                </div>
                <div className="min-w-0 flex-1">
                  <p className="text-sm font-bold uppercase tracking-wide text-cyan-200">Notification Refresh Update</p>
                  <p className="mt-2 text-base font-semibold leading-7 text-white sm:text-lg">{scrapeProgress}</p>
                  {selectedUni?.website && (
                    <a
            ...
            {selectedUni ? (
              <>
                ...
                <p className="text-white/30 text-xs mb-4">
                  No notifications are available for {selectedUni.name} yet.
                </p>
                <Button
                  size="sm"
                  disabled={scraping}
      ...
      <div className="flex items-center gap-1.5 overflow-x-auto pb-1">
        {ENTRANCE_STATES.map((s) => {
          ...
          return (
            ...
            >
              {s !== 'All' && meta.logo && (
                <img src={meta.logo} alt="" className="w-4 h-4 rounded-full object-cover ring-1 ring-white/20 hover:scale-[1.5] hover:shadow-lg hover:shadow-black/30 transition-all duration-300" loading="lazy" decoding="async" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
              )}
        ...
        <div className="flex items-center gap-1.5 overflow-x-auto pb-1">
          ...
          {boardFilterStates.map((s) => {
            ...
            return (
              ...
              >
                {meta.logo && (
                  <img src={meta.logo} alt="" className="w-5 h-5 rounded-full object-cover ring-1 ring-white/20 hover:scale-[1.5] hover:shadow-lg hover:shadow-black/30 transition-all duration-300" loading="lazy" decoding="async" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                )}
                {meta.label} ({count})
              </button>
            );
            ...
            >
              ...
              <div className="flex items-center gap-2.5">
                <div className={`w-10 h-10 rounded-full bg-linear-to-br ${stateMeta.gradient} flex items-center justify-center ring-1 ring-white/15`}>
                  {stateMeta.logo ? (
                    <img src={stateMeta.logo} alt={state} className="w-7 h-7 rounded-full object-cover hover:scale-[1.5] hover:shadow-lg hover:shadow-black/30 transition-all duration-300" loading="lazy" decoding="async" onError={(e) => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                  ) : (
      ...
      <div className="space-y-6">
        ...
        <Card id="admin-blog-posts" className="glass-card rounded-xl border border-white/5 scroll-mt-24">
          ...
          <CardContent className="space-y-4">
            {/* Blog Form */}
            <div className="admin-blog-editor space-y-4 rounded-xl border border-pink-400/15 bg-linear-to-br from-white/5.5 to-pink-500/3.5 p-4 shadow-lg shadow-black/10">
              <div className="flex flex-col gap-1">
                <h4 className="text-sm font-bold text-white">Professional Blog Writer</h4>
                <p className="text-xs leading-5 text-white/35">Markdown supported: headings, images, links, lists and preview.</p>
              </div>

              <div className="grid gap-3 lg:grid-cols-[1.25fr_0.75fr]">
                <div className="space-y-3">
                  <Input
                    placeholder="Professional blog title..."
                    value={blogForm.title}
                    onChange={(e) => setBlogForm(f => ({ ...f, title: e.target.value }))}
                    className="bg-white/5 border-white/10 text-white text-sm placeholder:text-white/25 rounded-lg"
                  />
                  <Textarea
                    ...
                    rows={2}
                    className="bg-white/5 border-white/10 text-white text-sm placeholder:text-white/25 rounded-lg resize-none"
                  />
                </div>
                ...
                <div className="space-y-2">
                  <Input
                    ...
                    className="bg-white/5 border-white/10 text-white text-xs placeholder:text-white/25 rounded-lg"
                  />
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      className="flex-1 bg-white/8 text-xs text-white hover:bg-white/12"
                    >
                      {uploadingBlogImage ? <Loader2 className="mr-1 h-3 w-3 animate-spin" /> : <Upload className="mr-1 h-3 w-3" />}
                      Upload Image
                    </Button>
                    <Button
                      type="button"
                      size="sm"
                      variant="ghost"
                      onClick={() => setBlogForm(f => ({ ...f, coverImage: '' }))}
                      className="text-xs text-white/40 hover:bg-white/10 hover:text-white"
                    >
                      Clear
                    </Button>
                  </div>
                  {blogForm.coverImage && (
                    <img src={blogForm.coverImage} alt="Blog cover preview" className="h-24 w-full rounded-lg border border-white/10 object-cover" loading="lazy" decoding="async" />
                  )}
                </div>
              </div>

              <div className="flex flex-wrap gap-1.5 rounded-lg border border-white/10 bg-black/15 p-2">
                <Button type="button" size="sm" variant="ghost" onClick={() => appendBlogContent('## New Section')} className="h-8 px-2 text-xs text-white/60 hover:bg-white/10 hover:text-white">H2</Button>
                <Button type="button" size="sm" variant="ghost" onClick={() => appendBlogContent('**Important text**')} className="h-8 px-2 text-xs text-white/60 hover:bg-white/10 hover:text-white">Bold</Button>
                <Button type="button" size="sm" variant="ghost" onClick={() => appendBlogContent('- Point one\n- Point two\n- Point three')} className="h-8 px-2 text-xs text-white/60 hover:bg-white/10 hover:text-white">List</Button>
                <Button type="button" size="sm" variant="ghost" onClick={() => appendBlogContent('> Important note for students.')} className="h-8 px-2 text-xs text-white/60 hover:bg-white/10 hover:text-white">Quote</Button>
                <Button type="button" size="sm" variant="ghost" onClick={insertBlogLink} className="h-8 px-2 text-xs text-white/60 hover:bg-white/10 hover:text-white">
                  <ExternalLink className="mr-1 h-3 w-3" /> Link
                </Button>
                <Button type="button" size="sm" variant="ghost" onClick={() => appendBlogContent('![Image alt text](https://example.com/image.jpg)')} className="h-8 px-2 text-xs text-white/60 hover:bg-white/10 hover:text-white">Image URL</Button>
                <Button type="button" size="sm" onClick={formatBlogProfessionally} className="ml-auto h-8 bg-pink-500/20 px-2 text-xs text-pink-100 hover:bg-pink-500/30">Make Professional</Button>
              </div>

              <div className="grid gap-3 lg:grid-cols-2">
                <Textarea
                  placeholder={`Write blog in professional format...\n\nExample:\n## Result Update\nShort details here.\n\n[Official Notice](https://example.com)`}
                  value={blogForm.content}
                  onChange={(e) => setBlogForm(f => ({ ...f, content: e.target.value }))}
                  rows={14}
                  className="min-h-80 bg-white/5 border-white/10 text-sm leading-6 text-white placeholder:text-white/25 rounded-lg resize-y"
                />
                <div className="min-h-80 rounded-lg border border-white/10 bg-white/[0.035] p-4">
                  <div className="mb-3 flex items-center justify-between">
                    <span className="text-xs font-bold uppercase tracking-wide text-white/40">Live Preview</span>
                    <span className="text-[10px] text-white/25">{normalizeReadTime(blogForm.readTime, blogForm.content)} read</span>
                  </div>
                  <ReactMarkdown
                    components={{
                      h2: ({ children }) => <h2 className="mb-2 mt-4 text-lg font-bold text-white">{children}</h2>,
                      h3: ({ children }) => <h3 className="mb-2 mt-3 text-base font-semibold text-white/85">{children}</h3>,
                      p: ({ children }) => <p className="mb-3 text-sm leading-7 text-white/55">{children}</p>,
                      a: ({ children, href }) => <a href={href} target="_blank" rel="noopener noreferrer" className="font-semibold text-cyan-300 underline underline-offset-4">{children}</a>,
                      ul: ({ children }) => <ul className="mb-3 list-disc space-y-1 pl-5 text-sm text-white/55">{children}</ul>,
                      blockquote: ({ children }) => <blockquote className="mb-3 border-l-2 border-pink-400/50 pl-3 text-sm text-white/55">{children}</blockquote>,
                      img: ({ src, alt }) => <img src={src || ''} alt={alt || ''} className="mb-3 max-h-52 w-full rounded-lg object-cover" loading="lazy" decoding="async" />,
                    }}
                  >
              ...
              <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
                ...
                <select
                  ...
                  className="rounded-lg border border-white/10 bg-[#151a2b] px-3 py-2 text-xs text-white"
                >
              ...
              <div className="flex flex-wrap items-center gap-2">
                <label className="flex cursor-pointer items-center gap-1.5 text-xs text-white/45">
                  <input
                    type="checkbox"
                ...
                <Button
                  ...
                  className="ml-auto bg-linear-to-r from-pink-500 to-purple-500 hover:from-pink-600 hover:to-purple-600 text-white text-xs"
                >
          ...
          >
            ...
            >
              ...
              {selectedBlogPost.coverImage ? (
                <img src={selectedBlogPost.coverImage} alt="" className="w-full h-48 sm:h-64 object-cover" loading="lazy" decoding="async" />
              ) : (
            ...
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="text-center space-y-1.5 max-w-lg">
                ...
                <p className="text-white/20 text-[11px] sm:text-xs">
                  Exam updates, admission alerts, board results, and entrance exams in one place. Never miss an important notice.
                </p>
              </div>
              {/* Divider */}
              ...
              <div className="flex flex-wrap items-center justify-center gap-2.5 text-[11px] font-semibold">
                {INFO_LINKS.map((item, index) => (
                  <span key={item.href} className="flex items-center gap-2.5">
                    <a href={item.href} className="text-white/45 transition hover:text-cyan-300">
                      {item.label}
                    </a>
                    {index < INFO_LINKS.length - 1 && <span className="text-white/15">•</span>}
                  </span>
                ))}
              </div>
